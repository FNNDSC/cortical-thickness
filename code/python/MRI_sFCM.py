...
class MRI_sFCM():
    ...
    def run(self):
        ...
        sFCM_ = sFCM(n_clusters=MRI_sFCM.N_CLUSTERS, min_error = MRI_sFCM.MIN_ERROR, max_iter = MRI_sFCM.MAX_ITER, verbose = False)
        sFCM_.fit(intensities)
        prob = sFCM_.soft_predict(intensities)
