...
#### Prepare files
${RESOURCES_DIR}/bin/mnc2nii ${TARGET_DIR}/${CASE}/temp/CSFfirstguess.mnc ${TARGET_DIR}/${CASE}/temp/gmm_csf_in.nii -short
...
${RESOURCES_DIR}/bin/mnc2nii ${TARGET_DIR}/${CASE}/input/recon_to31.mnc ${TARGET_DIR}/${CASE}/temp/mri.nii -short
#### Call Script
